...
from paymill.views import PaymillView
...
class PaymillViewTest(TestCase):
    ...
    def setUp(self):
        self.client = Client()
        self.url = reverse_lazy('paymill_webhook_callback')
    ...
    def test_valid_method(self, *args, **kwargs):
        httpretty.register_uri(httpretty.POST,
                               "http://beta.paymill.com/api/v2/stamp",
